...
const icons = {
  ...
  family:
    '<circle cx="8" cy="7" r="3"/><circle cx="17" cy="8" r="2.5"/><path d="M2.5 20v-2a5.5 5.5 0 0 1 11 0v2M16 14a4.5 4.5 0 0 1 5.5 4.4V20"/>',
  ...
  calendar:
    '<rect x="3" y="5" width="18" height="16" rx="4"/><path d="M7 3v4m10-4v4M3 11h18M8 15h1m6 0h1M8 18h1"/>',
  ...
  settings:
    '<path d="M4 6h16M4 12h16M4 18h16"/><circle cx="8" cy="6" r="2.5"/><circle cx="16" cy="12" r="2.5"/><circle cx="10" cy="18" r="2.5"/>',
  heart:
  ...
  edit: '<path d="m14 5 5 5M4 20l5-1L21 7a2 2 0 0 0-4-4L5 15ZM4 20l1-5"/>',
  ...
  camera:
    '<path d="M4 6h4l2-3h4l2 3h4a2 2 0 0 1 2 2v11H2V8a2 2 0 0 1 2-2Z"/><circle cx="12" cy="12" r="4"/>',
  wechat:
    '<path d="M14 15c-1 .5-2 .7-3 .7l-4 3v-3.3C4 14.1 2 12 2 9c0-4 4-7 9-7s9 3 9 7"/><path d="M22 15c0 3-3 5-6 5h-1l-3 2v-3c-2-1-3-2-3-4 0-3 3-5 6.5-5S22 12 22 15Z"/><path d="M7 7h.1M13 7h.1M13 14h.1M18 14h.1"/>',
...
const directory = 'apps/mini/src/static/icons';
...
for (const [name, body] of Object.entries(icons)) {
  for (const [tone, color] of Object.entries(colors)) {
    ...
    await sharp(Buffer.from(svg))
      .resize(96, 96)
      .png({ palette: true })
      .toFile(`${directory}/${name}-${tone}.png`);
  }
}
console.log(
  `Generated ${Object.keys(icons).length * Object.keys(colors).length} local interface icons`,
);
