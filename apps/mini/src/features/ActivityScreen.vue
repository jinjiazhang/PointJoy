...
const metrics=['CHECK','COUNT','DURATION','DISTANCE'];const weekdays=['周一','周二','周三','周四','周五','周六','周日'];const titles:Record<string,string>={home:'家庭概览',todos:'家庭待办',plans:'活动计划',planEdit:props.query.id?'编辑计划':'新建计划',plan:'计划详情',occurrence:'完成记录',today:'今天',activity:'记录完成'}
