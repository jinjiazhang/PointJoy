...
2026-09-19 已通过微信官方编译并上传 **1.1.0 开发版本**，完整包 **753983 字节**，32 个页面。基于 uni-app / Vue 3 / TypeScript 更新登录、家庭、活动、奖励、积分与孩子模式，新增玻璃导航、悬浮标签栏、统一图标及底部兑换确认浮层。微信头像、昵称和照片自动保存流程继续保留。详见 [界面实现说明](../docs/mini-ui-v1.1.md)。
